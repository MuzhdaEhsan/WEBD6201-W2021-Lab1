...
(function()
{
    ...
    function displayProjects()
    {
		...
		MuzhdaFirstProjectText.innerText = "This a project which recorded the details for a salesperson, client, and calls into database. All the users in this project had their own rights. Admin was the person who could grant and revoke the rights from other users.";
