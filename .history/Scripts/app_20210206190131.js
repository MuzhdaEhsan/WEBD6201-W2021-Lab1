...
(function()
{
    ...
    function displayProjects()
    {
		...
		MuzhdaSecondProjectText.innerText = "<p>Tesla, Inc., is an American electric vehicle and clean energy company based in Palo Alto, California. This website was designed to show provide some information about Tesla.</p>";
