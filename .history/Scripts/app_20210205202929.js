...
(function()
{
    function displayHome()
    {
        ...
        let paragraphOneElement = document.getElementById("myDiv");

        paragraphOneElement.style.backgroundImage = paragraphOneText;
        ...
        let paragraphIndex = `<p id="mainParagraph" class="fs-7 fw-bold">this is some other details.</p>`;
