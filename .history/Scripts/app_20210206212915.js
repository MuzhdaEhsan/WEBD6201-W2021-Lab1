...
(function()
{
    ...
    {
      /*let navList = document.getElementById("myNav");
      let el = document.createElement("a");
      el.innerText = "Human Resource";
      ...
      //let navData = document.getElementById("myNav").innerHTML;
      //document.getElementById("demo").innerHTML = x;

      //navData.createElement("li");
     ...
     // menu.insertBefore(newItem, menu.childNodes[3]);

      //var nav=document.getElementById("myNav");
      //var node = document.createElement("a");
     // var textnodee = document.createTextNode("newlink");
     // node.appendChild(textnodee);
